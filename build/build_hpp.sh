...
NEW_SINGLE_HEADER=ApprovalTestsQt.$VERSION.hpp
...
STARTER_PROJECT_DIR=../../ApprovalTests.Cpp.Qt.StarterProject
...
sed -i '' -e "s/$LAST_VERSION/$VERSION/" $STARTER_PROJECT_DIR/lib/ApprovalTestsQt.hpp
...
open "https://github.com/approvals/ApprovalTests.cpp.Qt/releases/new?tag=$VERSION&title=Single%20Hpp%20File%20-%20$VERSION"

# Draft the tweet
open "https://twitter.com/intent/tweet?text=%23ApprovalTests.cpp.Qt+$VERSION+released%2C+now+with+___%21%0D%0Ahttps%3A%2F%2Fgithub.com%2Fapprovals%2FApprovalTests.cpp.Qt%2Freleases%2Ftag%2F$VERSION+%0D%0Aor+try+the+starter+project%3A+https%3A%2F%2Fgithub.com%2Fapprovals%2FApprovalTests.cpp.Qt.StarterProject%0D%0AThanks+%40LlewellynFalco+%40ClareMacraeUK+%21"
